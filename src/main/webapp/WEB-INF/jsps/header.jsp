        ...
        <header class="header navbar navbar-expand-sm">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="#">
                        <img src="<c:url value="/resources/assets/img/logo.png"/>" class="navbar-logo" alt="logo">
                    </a>
                </li>
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="<c:url value="/resources/assets/img/profile-17.jpg"/>" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                                <sec:authorize
							access="isAuthenticated()">
							
                                    <h5><sec:authentication property="principal.username" /></h5>
                                    <%-- <p><sec:authentication property="principal.username" /></p> --%></sec:authorize>
                                </div>
                            </div>
                        </div>
